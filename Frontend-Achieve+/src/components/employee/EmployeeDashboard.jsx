...
const EmployeeDashboard = () => {
  ...
  const [quickStats, setQuickStats] = useState({
    points: 0,
    completedTasks: 0,
    totalBadges: 0, // Changed from badges to totalBadges for consistency
    rank: 0
  });
  ...
  const employeeSidebarItems = [
    ...
    { title: 'Leaderboard', path: '/employee-leaderboard', icon: 'bi-bar-chart-line' },
    ...
    const fetchData = async () => {
      try {
        ...
        setQuickStats({
          ...
          totalBadges: stats.totalBadges || 0, // Use the stats.totalBadges for consistency
  ...
  const getRecentActivities = () => {
    ...
    // Sort and return activities (without trying to parse dates since we're using static text)
